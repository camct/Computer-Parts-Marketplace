   ...
   endforeach;
	...
	foreach ($prodTrans as $cool):
	  ...
	  if (!in_array($cool['transaction_id'], $TransArray)) {
		...
		case '/updatePSU.php':                   // URL (without file name) to a default screen
			require 'dontOwn.php';
			break; 
	...
	$sqlUpProd = "UPDATE project.psu SET Brand = '$brand', Year = '$year', Price = '$price', Voltage = '$volt', Current_rating = '$curr' WHERE Product_ID = '$prod_ID'";
