   ...
   endforeach;
	...
	foreach ($prodTrans as $cool):
	  ...
	  if (!in_array($cool['transaction_id'], $TransArray)) {
		...
		case '/updateRAM.php':                   // URL (without file name) to a default screen
			require 'dontOwn.php';
			break; 
	...
	$sqlUpProd = "UPDATE project.ram SET Brand = '$brand', Year = '$year', Price = '$price', Mem_size = '$size' WHERE Product_ID = '$prod_ID'";
