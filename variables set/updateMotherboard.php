   ...
   endforeach;
	...
	foreach ($prodTrans as $cool):
	  ...
	  if (!in_array($cool['transaction_id'], $TransArray)) {
		...
		case '/updateMotherboard.php':                   // URL (without file name) to a default screen
			require 'dontOwn.php';
			break; 
	...
	$sqlUpProd = "UPDATE project.motherboard SET Brand = '$brand', Year = '$year', Price = '$price', Sup_CPUs = '$sup' WHERE Product_ID = '$prod_ID'";
