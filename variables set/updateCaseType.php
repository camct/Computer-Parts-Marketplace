   ...
   endforeach;
	...
	foreach ($prodTrans as $cool):
	  ...
	  if (!in_array($cool['transaction_id'], $TransArray)) {
		...
		case '/updateCaseType.php':                   // URL (without file name) to a default screen
			require 'dontOwn.php';
			break; 
	...
	$sqlUpProd = "UPDATE project.case_type SET Brand = '$brand', Year = '$year', Price = '$price', Size = '$size' WHERE Product_ID = '$prod_ID'";
