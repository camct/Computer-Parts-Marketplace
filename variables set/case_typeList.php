...
<?php
 ...
 $dbname = 'project';  
   ...
   $sql = "SELECT * FROM project.case_type";
   $whole = $db->query($sql);?>
...
<?php foreach ($whole as $cool): ?>
  <tr>
	 ...
	 <td><?php echo $cool['Size']; ?></td>	 
	 <td>
	 
	<form name="case_typeDelForm" action="deleteCaseType.php" method="post">   
	...
	<td>
	<form name="case_typeTransForm" action="updateCaseTypeForm.php" method="post">   
	<div class="row mb-1 mx-1">
    <input type="hidden" name="prodID" value=<?php echo $cool['Product_ID']; ?> />
	...
	<td>
	<form name="case_typeBuyForm" action="buyCaseType.php" method="post">   
	<div class="row mb-1 mx-1">
    <input type="hidden" name="prodID" value=<?php echo $cool['Product_ID']; ?> />
...
<form method="GET">
        ...
        if (isset($_GET['min_price']) && isset($_GET['max_price'])) {
          ...
          $query = "SELECT * FROM project.case_type WHERE case_type.price > $min_price AND case_type.price < $max_price";

        }
        else {
          $query = "SELECT * FROM project.case_type";
        }
...
<a href="case_typeForm.php">Click here to add a new item of this type</a>
<br>
