   ...
   endforeach;
	...
	foreach ($prodTrans as $cool):
	  ...
	  if (!in_array($cool['transaction_id'], $TransArray)) {
		...
		case '/updateMonitor.php':                   // URL (without file name) to a default screen
			require 'dontOwn.php';
			break; 
	...
	$sqlUpProd = "UPDATE project.monitor SET Brand = '$brand', Year = '$year', Price = '$price', Refresh_Rate = '$rate', Dimensions = '$dim' WHERE Product_ID = '$prod_ID'";
