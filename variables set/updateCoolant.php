   ...
   endforeach;
	...
	foreach ($prodTrans as $cool):
	  ...
	  if (!in_array($cool['transaction_id'], $TransArray)) {
		...
		case '/updateCoolant.php':                   // URL (without file name) to a default screen
			require 'dontOwn.php';
			break; 
	...
	$sqlUpProd = "UPDATE project.coolant SET Brand = '$brand', Year = '$year', Main_Auxiliary = '$main' WHERE Product_ID = '$prod_ID'";
