   ...
   endforeach;
	...
	foreach ($prodTrans as $cool):
	  ...
	  if (!in_array($cool['transaction_id'], $TransArray)) {
		...
		case '/updateGPU.php':                   // URL (without file name) to a default screen
			require 'dontOwn.php';
			break; 
	...
	$sqlUpProd = "UPDATE project.gpu SET Brand = '$brand', Year = '$year', Price = '$price', Memory_Size = '$memory_size' WHERE Product_ID = '$prod_ID'";
