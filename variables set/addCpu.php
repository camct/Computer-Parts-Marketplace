 ...
 $dbname = 'project';  
  ...
  // echo $email;
   ...
   $maxTrans = $db->query($sqlMaxTrans); 
	...
	$sqlInsProd = "INSERT INTO project.cpu (Product_ID, Brand, Year, Price, Clock_speed, Overclocking_support) VALUES ($maxID + 1, '$brand', '$year', '$price', '$clock', '$over')";
	...
	//echo "New TransProf created successfully";
	} else {
